...
Cyber-physicals are distributed hence there are different ways to process the sensor data incoming into the computation nodes. \todo{különböző módok bemutatása mi diszjunk elosztott modellt választottunk}

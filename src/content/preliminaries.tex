...
\viatra{} Query Language syntax conform with this structure as this restriction leads to more easily understandable .
...
\todo{innentől kicsit pontosítani és befejezni, frame fogalmát felhasználni valahogy}
Our problem then is the following: find all the variable bindings, which satisfies the constraints of the body.
